...
is_college_only = True#筛选非大专 仅保留大学
# --------------------------------------
...
if is_id_there == False:
    ...
    for i in range(len(all_school_ids)):
        ...
        if "职业" in school_name or "技术" in school_name or "专科" in school_name and is_college_only == True:#筛选结果
            continue
